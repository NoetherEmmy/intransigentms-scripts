...
function startInstance(eim) {
    if (eim.getPlayerCount() > 0) {
        ...
        if (eim.getName().equals("lolcastle1")) {
            for (x = 0; x < 100; x++) {
                mob = Packages.net.sf.odinms.server.life.MapleLifeFactory.getMonster(9500169);
                overrideStats = new Packages.net.sf.odinms.server.life.MapleMonsterStats();
            ...
            for (x = 0; x < 10; x++) {
                mob = Packages.net.sf.odinms.server.life.MapleLifeFactory.getMonster(9300136);
                overrideStats = new Packages.net.sf.odinms.server.life.MapleMonsterStats();
            ...
            for (x = 0; x < 100; x++) {
                mob = Packages.net.sf.odinms.server.life.MapleLifeFactory.getMonster(5120000);
                overrideStats = new Packages.net.sf.odinms.server.life.MapleMonsterStats();
            ...
            for (x = 0; x < 3; x++) {
                mob = Packages.net.sf.odinms.server.life.MapleLifeFactory.getMonster(9300012);
                overrideStats = new Packages.net.sf.odinms.server.life.MapleMonsterStats();
            ...
            for (x = 0; x < 100; x++) {
                ...
                mob = Packages.net.sf.odinms.server.life.MapleLifeFactory.getMonster(mobId);
                overrideStats = new Packages.net.sf.odinms.server.life.MapleMonsterStats();
            ...
            for (x = 0; x < 3; x++) {
                mob = Packages.net.sf.odinms.server.life.MapleLifeFactory.getMonster(9300105);
                overrideStats = new Packages.net.sf.odinms.server.life.MapleMonsterStats();
                overrideStats.setHp(mob.getHp());
                overrideStats.setExp(mob.getExp() / 4);
                overrideStats.setMp(mob.getMaxMp());
            ...
            for (x = 0; x < 3; x++) {
                mob = Packages.net.sf.odinms.server.life.MapleLifeFactory.getMonster(9300152);
                overrideStats = new Packages.net.sf.odinms.server.life.MapleMonsterStats();
