...
function takeoff() {
	...
	if(toggleMsg) {
		KC_docked.broadcastMessage(MaplePacketCreator.serverNotice(0, "The subway train to NLC has take off."));
		NLC_docked.broadcastMessage(MaplePacketCreator.serverNotice(0, "The subway train to KC has take off."));
	}
