            ...
            if (status === 0) {
                ...
                if (dialog[0] === 0) {
                    ...
                    if (selection === 1) {
                        ...
                        p.dropMessage(6, "You have improved attack speed due to your initiative and tactical advantage.");
                ...
                cm.giveDebuff(126, 1);
                p.dropMessage(6, "You have been slowed.");
                cm.dispose();
                return;
            }
            if (selection === pselection) break;
        }
