 ...
 * Shanks
 * ID: 22000
 * Maple Road | Southperry (60000)
 * Brings you to Victoria Island
 */
    ...
    if (status === 0) {
        ...
        if (cm.haveItem(4031801)) {
            ...
            if (cm.getLevel() >= 7) {
                ...
                cm.sendOk("Let's see... I don't think you are strong enough. You'll have to be at least #blevel 7#k to go to Victoria Island.");
                cm.dispose();
                return;
            }
        }
