...
var status = 0;
var address = "";
var maleitems = [1050018, 1050051, 1050052, 1050045, 1050046, 1050047, 1050048, 1050049, 1052116, [1040094, 1060083], [1040095, 1060084], [1040096, 1060085], [1040097, 1060086], [1040087, 1060076], [1040088, 1060077], [1040089, 1060078]];
var femaleitems = [1051017, 1051037, 1051038, 1051039, 1051030, 1051031, 1051032, 1051033, 1051034, 1052116, [1041077, 1061076], [1041078, 1061077], [1041079, 1061078], [1041080, 1061079], [1041087, 1061086], [1041088, 1061087], [1041089, 1061088]];
var itemarray = [];
var mobId1 = 5220003;
var mobId2 = 6230400;
...
function action(mode, type, selection) {
    ...
    if (mode === -1) {
        ...
        } else if (cm.onQuest(id) && (p.getQuestKills(mobId1) >= p.getCQuest().getNumberToKill(mobId1) ||
                                      p.getQuestKills(mobId2) >= p.getCQuest().getNumberToKill(mobId2))) {
            if (status === 0) {
                cm.sendSimple(cm.selectQuest(id, "..."));
            } else if (status === 1) {
                cm.sendOk(cm.showReward("Excellent. Here, I threw in a little extra. Oh, and one more thing..."));
            } else if (status === 2) {
