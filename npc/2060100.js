...
//carta
function start(){
var quast = Packages.net.sf.odinms.server.quest.MapleQuest.getInstance(6301);
if(cm.getChar().getQuest(quast).getStatus().equals(Packages.net.sf.odinms.client.MapleQuestStatus.Status.STARTED)){
//4000175
