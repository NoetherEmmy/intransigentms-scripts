    ...
    if (mode === -1) {
        ...
        if (status === 0) {
            ...
            check = selection;
                ...
                cm.sendYesNo(msg + "\r\n\r\nOkay! Please beware that you may be running into some monsters around there though, so make sure not to get caught off-guard. Alright, would you like to head over to #m110000000# right now?");
            } else if (selection === 2) {
