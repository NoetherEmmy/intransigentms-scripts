            ...
            switch (status) {
                case 0:
                    ...
                    if (cm.itemQuantity(reqItem[0]) >= reqItem[1]) {
                        cm.sendNext("You got the stuff already? Wow! Let's see here...");
                    } else {
                ...
                case 1:
                    if (cm.itemQuantity(reqItem[0]) >= reqItem[1]) {
                        cm.sendOk("Ooooooh! These will make for excellent ear swabs! Very cushy.\r\n\r\nHere, take this:  #i" + proofOfLove + "#");
                        cm.gainItem(reqItem[0], -reqItem[1]);
                        cm.gainItem(proofOfLove, 1);
                        cm.dispose();
                        return;
                    } else {
                        cm.sendAcceptDecline("Oh, I know!\r\n\r\nI've seen those #dTeddy Bears#k teddying (or whatever they do) around here, you know. Weird walking stuffed animals with wind-up springs. Walk around the toy halls all the time.\r\n\r\nWell.\r\n\r\nI think #rtheir guts#k would make for delightful ear swabs! What do you say? Could you get me\r\n\r\n\t  #i" + reqItem[0] + "#  #bx" + reqItem[1] + "#k?");
                    }
                    break;
                default:
                    cm.dispose();
